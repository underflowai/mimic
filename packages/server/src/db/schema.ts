import { jsonb, pgEnum, pgTable, text, timestamp, integer, boolean, uuid } from 'drizzle-orm/pg-core'
...
export const callStatusEnum = pgEnum('call_status', ['pending', 'in_progress', 'completed', 'failed'])
